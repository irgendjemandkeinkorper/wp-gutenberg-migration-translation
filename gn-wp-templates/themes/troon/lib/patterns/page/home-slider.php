...
echo wp_kses_post( nbcsn_block_patterns_get_pattern_template_content( ['title' => '', 'location' => 'hero/slider', 'type' => 'theme'] ) );
?>
...
<div class="wp-block-media-text has-media-on-the-right is-stacked-on-mobile ghostkit-custom-ZJSC87" style="grid-template-columns:auto 35%" data-ghostkit-sr="fade-right;distance:100px"><div class="wp-block-media-text__content"><!-- wp:quote {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"className":"is-style-default","fontSize":"h3","ghostkitSR":"fade-left;distance:200px"} -->
<blockquote class="wp-block-quote is-style-default has-h-3-font-size" style="font-style:normal;font-weight:600" data-ghostkit-sr="fade-left;distance:200px"><!-- wp:paragraph {"className":"ghostkit-custom-Z1GWfGs","fontSize":"h1","ghostkitStyles":{".ghostkit-custom-Z1GWfGs":{"marginBottom":"0%20!important"}},"ghostkitClassname":"ghostkit-custom-Z1GWfGs","ghostkitId":"Z1GWfGs","ghostkitSpacings":{"marginBottom":"0","!important":true}} -->
