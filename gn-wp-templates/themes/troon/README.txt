...
Theme GitHub link: https://github.com/wpcomvip/golfnow/tree/master/themes/troon/.

## Setting up your build

1. Navigate to your wp-content directory
2. From there, change directory to `themes/troon/lib/processor-styles
...
2. In the command line, change directory to the troon/lib/processor-styles folder.

3. Type the command `npm install` to install dependencies.

4. Make sure NBCSN-Basic-Frameworks Plugin is initialized
