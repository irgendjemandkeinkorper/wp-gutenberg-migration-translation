...
<div class="entry-header-custom entry-header alignfull">
    <div class="site-inner text-center">
        <h1 class="entry-title woocommerce-products-header__title page-title"><?php echo _e( 'Upcoming Events', 'gn-mulberry' ) ?></h1>
    </div>
    <img alt="<?php echo _e( 'Image of golf ball on tee on grass.', 'gn-mulberry' ) ?>" src="<?php echo $headerImage; ?>" class="singular-image entry-image">
</div>
