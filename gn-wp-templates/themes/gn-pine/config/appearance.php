<?php
/**
 * GolfNow - Pine appearance settings.
 *
...
// This is just for safety so that certain features aren't available unless the NBCSN Pine Frameworks Plugin is enabled 
...
if ( !function_exists( 'theme_build_theme_appearance' ) ) {
    function theme_build_theme_appearance() {
        ...
        $theme_appearance_default_colors = [
            'primary'   => [
                'color'         => '#bc542b',
                'description'   => __( 'The main color to be used on the site.', 'gn-pine' ),
                'label'         => __( 'Primary Color', 'gn-pine' ),
            ],
            'secondary' => [
                'color'         => '#504D14',
                'description'   => __( 'The accent color to be used on the site', 'gn-pine' ),
                'label'         =>__( 'Secondary Color', 'gn-pine' ),
            ],
        ];
        ...
        $appearance = [
            ...
            'default-header-image'      => 'https://vip.teeitup.com/gn-basic/wp-content/uploads/sites/8604/2023/07/pine-header.jpg',
            ...
            'editor-font-sizes'    => [
                [
                    'name' => __( 'Smaller', 'gn-pine' ),
                    'size' => 12,
                    'slug' => 'smaller',
                ],
                [
                    'name' => __( 'Small', 'gn-pine' ),
                    'size' => 14,
                    'slug' => 'small',
                ],
                [
                    'name' => __( 'Normal', 'gn-pine' ),
                    'size' => 16,
                    'slug' => 'normal',
                ],
                [
                ...
                [
                    'name' => __( 'Display 3', 'gn-pine' ),
                    'size' => 48,
                    'slug' => 'display-3',
                ],
                [
                    'name' => __( 'Display 2', 'gn-pine' ),
                    'size' => 55,
                    'slug' => 'display-2',
                ],
                [
                    'name' => __( 'Display 1', 'gn-pine' ),
                    'size' => 60,
                    'slug' => 'display-1',
                ],
            ],
