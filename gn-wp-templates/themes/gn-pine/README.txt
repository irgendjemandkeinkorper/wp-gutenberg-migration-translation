...
Theme GitHub link: https://github.com/wpcomvip/golfnow/tree/master/themes/gn-pine/.

## Setting up your build

1. Navigate to your wp-content directory
2. From there, change directory to `themes/gn-pine/lib/processor-styles
...
This theme was adapded from the StudioPress Genesis Pine theme.
...
2. In the command line, change directory to the gn-pine/lib/processor-styles folder.

3. Type the command `npm install` to install dependencies.

4. Make sure NBCSN-Pine-Frameworks Plugin is initialized
