...
add_action( 'wp_enqueue_scripts', 'sunstone_pro_enqueue_gutenberg_frontend_styles' );
/**
 * Enqueues Gutenberg front-end styles.
 *
 * @since 2.7.0
 */
function sunstone_pro_enqueue_gutenberg_frontend_styles() {
...
add_action( 'enqueue_block_editor_assets', 'sunstone_pro_block_editor_styles' );
/**
 * Enqueues Gutenberg admin editor fonts and styles.
 *
 * @since 2.7.0
 */
function sunstone_pro_block_editor_styles() {
...
add_filter( 'body_class', 'sunstone_pro_blocks_body_classes' );
/**
 ...
 */
function sunstone_pro_blocks_body_classes( $classes ) {
...
$sunstone_pro_appearance = genesis_get_config( 'appearance' );

// Adds support for editor font sizes.
add_theme_support(
	'editor-font-sizes',
	$sunstone_pro_appearance['editor-font-sizes']
);

// Adds support for editor color palette.
add_theme_support(
	'editor-color-palette',
	$sunstone_pro_appearance['editor-color-palette']
);

require_once get_stylesheet_directory() . '/lib/gutenberg/inline-styles.php';

add_action( 'after_setup_theme', 'sunstone_pro_content_width', 0 );
/**
 * Set content width to match the “wide” Gutenberg block width.
 */
function sunstone_pro_content_width() {

	$appearance = genesis_get_config( 'appearance' );

	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound -- See https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/924
	$GLOBALS['content_width'] = apply_filters( 'sunstone_pro_content_width', $appearance['content-width'] );
