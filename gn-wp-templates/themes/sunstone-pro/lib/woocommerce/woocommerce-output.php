 ...
 * Sunstone Pro.
 *
 * This file adds the WooCommerce styles and the Customizer additions for WooCommerce to the Sunstone Pro Theme.
 *
 * @package Sunstone Pro
 */

add_filter( 'woocommerce_enqueue_styles', 'sunstone_pro_woocommerce_styles' );
/**
 ...
 */
function sunstone_pro_woocommerce_styles( $enqueue_styles ) {
...
add_action( 'wp_enqueue_scripts', 'sunstone_pro_woocommerce_css' );
/**
 ...
 */
function sunstone_pro_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'sunstone_pro_link_color', $appearance['default-colors']['link'] );
	$color_accent = get_theme_mod( 'sunstone_pro_accent_color', $appearance['default-colors']['link-hover'] );
	...
	',
		$color_accent,
		sunstone_pro_color_contrast( $color_accent )
	) : '';
