 ...
 * Sunstone Pro.
 *
 * This file adds the required helper functions used in the Sunstone Pro Theme.
 *
 ...
 */
function sunstone_pro_color_contrast( $color ) {
 ...
 */
function sunstone_pro_color_brightness( $color, $change ) {
