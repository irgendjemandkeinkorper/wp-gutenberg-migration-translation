...
function genesis_sample_enqueue_scripts_styles() {
	...
	wp_enqueue_script(
		'topaz-custom-js',
		get_stylesheet_directory_uri() . '/lib/js/topaz-custom-js.js',
		[],
		genesis_get_theme_version(),
	);
...
function genesis_block_styles_and_variations() {
	wp_enqueue_script(
		'topaz-custom-block-styles',
		get_stylesheet_directory_uri() . '/lib/gutenberg/extra-styles.js',
		array( 'wp-blocks', 'wp-dom-ready', 'wp-edit-post' ),
		genesis_get_theme_version(),
	);
}

add_action( 'enqueue_block_editor_assets', 'genesis_block_styles_and_variations' );
...
add_action( 'genesis_before_header', 'topaz_before_header' );
function topaz_before_header() {

	genesis_widget_area( 'before-header', array(
		'before' => '<div class="before-header" class="widget-area"><div class="site-inner"><div class="wrap">',
		'after'  => '</div></div></div>',
	) );
...
genesis_register_sidebar( array(
	'id'          => 'before-header',
	'name'        => __( 'Before Header', 'genesis-sample' ),
	'description' => __( 'This is the section above the header.', 'genesis-sample' ),
) );

// Adds image sizes.
add_image_size( 'sidebar-featured', 75, 75, true );
add_image_size( 'genesis-singular-images', 1920, 550, array( 'center', 'center' ) );

// Changes Position for singular images to be within the page header.
