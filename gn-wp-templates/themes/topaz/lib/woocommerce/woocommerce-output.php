...
add_filter( 'woocommerce_enqueue_styles', 'topaz_woocommerce_styles' );
/**
 ...
 */
function topaz_woocommerce_styles( $enqueue_styles ) {
...
add_action( 'wp_enqueue_scripts', 'topaz_woocommerce_css' );
/**
 ...
 */
function topaz_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'topaz_link_color', $appearance['default-colors']['link'] ?? '' );
	$color_accent = get_theme_mod( 'topaz_accent_color', $appearance['default-colors']['accent'] ?? '' );
