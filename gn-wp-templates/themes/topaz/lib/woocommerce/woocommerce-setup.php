...
add_filter( 'woocommerce_style_smallscreen_breakpoint', 'topaz_woocommerce_breakpoint' );
/**
 ...
 */
function topaz_woocommerce_breakpoint() {
...
add_filter( 'genesiswooc_products_per_page', 'topaz_default_products_per_page' );
/**
 ...
 */
function topaz_default_products_per_page() {

	return 8;

}

add_filter( 'woocommerce_pagination_args', 'topaz_woocommerce_pagination' );
/**
 ...
 */
function topaz_woocommerce_pagination( $args ) {
...
add_action( 'after_switch_theme', 'topaz_woocommerce_image_dimensions_after_theme_setup', 1 );
/**
 * Defines WooCommerce image sizes on theme activation.
 *
 * @since 2.3.0
 */
function topaz_woocommerce_image_dimensions_after_theme_setup() {
	...
	topaz_update_woocommerce_image_dimensions();

}

add_action( 'activated_plugin', 'topaz_woocommerce_image_dimensions_after_woo_activation', 10, 2 );
/**
 ...
 */
function topaz_woocommerce_image_dimensions_after_woo_activation( $plugin ) {
 ...
 * @since 2.3.0
 */
function topaz_update_woocommerce_image_dimensions() {
...
add_filter( 'woocommerce_get_image_size_gallery_thumbnail', 'topaz_gallery_image_thumbnail' );
/**
 ...
 */
function topaz_gallery_image_thumbnail( $size ) {
