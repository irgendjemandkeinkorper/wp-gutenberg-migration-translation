<?php
/**
 * GolfNow - Dogwood appearance settings.
 *
...
if ( !function_exists( 'theme_build_theme_appearance' ) ) {
    function theme_build_theme_appearance() {
        ...
        $theme_appearance_default_colors = [
            'primary'   => [
                'color'         => '#EFAF1A',
                'description'   => __( 'The main color to be used on the site.', 'gn-dogwood' ),
                'label'         => __( 'Primary Color', 'gn-dogwood' ),
            ],
            'secondary' => [
                'color'         => '#26179b',
                'description'   => __( 'The accent color to be used on the site', 'gn-dogwood' ),
                'label'         =>__( 'Secondary Color', 'gn-dogwood' ),
            ],
        ];
        ...
        $appearance = [
            ...
            'editor-font-sizes'    => [
                [
                    'name' => __( 'Smaller', 'gn-dogwood' ),
                    'size' => 12,
                    'slug' => 'smaller',
                ],
                [
                    'name' => __( 'Small', 'gn-dogwood' ),
                    'size' => 14,
                    'slug' => 'small',
                ],
                [
                    'name' => __( 'Normal', 'gn-dogwood' ),
                    'size' => 16,
                    'slug' => 'normal',
                ],
                [
                    'name' => __( 'h4', 'gn-dogwood' ),
                    'size' => 18,
                    'slug' => 'h4',
                ],
                [
                    'name' => __( 'h3', 'gn-dogwood' ),
                    'size' => 22,
                    'slug' => 'h3',
                ],
                [
                    'name' => __( 'h2', 'gn-dogwood' ),
                    'size' => 28,
                    'slug' => 'h2',
                ],
                [
                    'name' => __( 'h1', 'gn-dogwood' ),
                    'size' => 38,
                    'slug' => 'h1',
                ],
                [
                    'name' => __( 'Display 3', 'gn-dogwood' ),
                    'size' => 48,
                    'slug' => 'display-3',
                ],
                [
                    'name' => __( 'Display 2', 'gn-dogwood' ),
                    'size' => 55,
                    'slug' => 'display-2',
                ],
                [
                    'name' => __( 'Display 1', 'gn-dogwood' ),
                    'size' => 60,
                    'slug' => 'display-1',
                ],
            ],
...
// In the customizer preview, theme mods may not be applied yet on first build,
// so do one forced rebuild — but only once per request via static guard.
