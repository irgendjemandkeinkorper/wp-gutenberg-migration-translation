# GolfNow Dogwood Theme

GitHub project link: https://github.com/wpcomvip/golfnow/.
Theme GitHub link: https://github.com/wpcomvip/golfnow/tree/master/themes/gn-dogwood/.

## Setting up your build

1. Navigate to your wp-content directory
2. From there, change directory to `themes/gn-dogwood/lib/processor-styles
...
This theme was adapded from the StudioPress Genesis Dogwood theme.
...
2. In the command line, change directory to the gn-dogwood/lib/processor-styles folder.

3. Type the command `npm install` to install dependencies.

4. Make sure NBCSN-Basics-Frameworks Plugin is initialized
