 ...
 * Zilker.
 *
 * This file adds the Customizer additions to the Zilker Theme.
 *
 * @package Zilker
...
add_action( 'customize_register', 'zilker_customizer_register' );
/**
 ...
 */
function zilker_customizer_register( $wp_customize ) {
 ...
 */
function zilker_validate_logo_width( $validity, $width ) {
