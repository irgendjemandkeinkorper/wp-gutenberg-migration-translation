...
// ⚡ Bolt: Extract to React.memo to prevent O(N) list re-renders when a single batchStatus item updates
const BatchItem = memo(({ page, itemStatus }: { page: CrawledPage; itemStatus?: BatchState }) => {
  return (
    <li>
      <span>
