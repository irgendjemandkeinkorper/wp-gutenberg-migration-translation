...
const BatchListItem = memo(
  function BatchListItem({ page, itemStatus }: { page: CrawledPage; itemStatus?: BatchState }) {
    return (
      <li>
        <span>
