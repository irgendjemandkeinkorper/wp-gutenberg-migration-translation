...
export function SourceInputPanel({
  ...
  const isConvertDisabled = busy || (tab === "paste" && !pastedHtml.trim()) || (tab === "fetch" && !pageUrl.trim());
      ...
      <div className="conversion-action">
        ...
        {tab === "batch" ? (
          <div className="batch-actions">
            {batchBusy ? (
              ...
              <button
                ...
                title={batch.length === 0 ? "Load a crawl JSON file to start." : undefined}
              >
          ...
          <button
            ...
            title={isConvertDisabled && !busy ? "Please provide input to convert." : undefined}
          >
