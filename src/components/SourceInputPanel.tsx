      ...
      <div className="conversion-action">
        ...
        {tab === "batch" ? (
          <div className="batch-actions">
            {batchBusy ? (
              ...
              <button
                ...
                title={batch.length === 0 ? "Load a crawl JSON file to start batch" : undefined}
              >
          ...
          <button
            ...
            title={tab === "paste" && !pastedHtml.trim() ? "Paste HTML source to convert" : tab === "fetch" && !pageUrl.trim() ? "Enter a URL to fetch and convert" : undefined}
          >
