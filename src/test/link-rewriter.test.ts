...
describe("authoritative internal-link rewriting", () => {
  it("rewrites mapped pages and preserves valid fragments", () => {
    const result = rewriteInternalLinks('<p><a href="/target#team">Team</a><a href="https://other.test">External</a></p>', { sourcePageUrl: "https://example.test/source", destinations });
  ...
  it("reports missing destinations and anchors without guessing slugs", () => {
    const result = rewriteInternalLinks('<a href="/target#missing">Missing anchor</a><a href="/unknown">Unknown</a>', { sourcePageUrl: "https://example.test/source", destinations });
    expect(result.rewritten).toBe(1);
