...
describe("CMS source adapters", () => {
  it("detects WordPress and emits bounded extraction hints", () => {
    ...
    const input = {
      ...
      html: '<meta name="generator" content="WordPress 6.8"><article class="entry-content"><img data-src="/hero.jpg"></article>',
    };
  ...
  it("detects Drupal and Joomla with auditable evidence", () => {
    ...
    const drupalInput = {
      url: "https://drupal.test",
      html: '<meta name="generator" content="Drupal 10"><main class="region-content">Drupal</main>',
    };
    ...
    const joomlaInput = {
      ...
      html: '<meta name="generator" content="Joomla"><main class="item-page">Joomla</main>',
    };
  ...
  it("chooses a deterministic adapter and keeps generic fallback available", () => {
    ...
    const selected = selectSourceAdapter(input, [
      createWordPressSourceAdapter(),
      createDrupalSourceAdapter(),
      createJoomlaSourceAdapter(),
    ]);
